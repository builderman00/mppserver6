...
if (message.startsWith(config.prefix)) {
	...
	if (cmd === "reload" && user.rank >= 3) {
		...
		var cmds = {help: 0, id: 0, reload: 5, setrank: 5, quota: 5, bot: 5, unban: 5, mute: 4, unmute: 5, perms: 5, announce: 5, tag: 6, token: 6, js: 6, kick: 3, info: 5, gentoken: 5, meow: 2, getdb: 6, savedb: 6 };
